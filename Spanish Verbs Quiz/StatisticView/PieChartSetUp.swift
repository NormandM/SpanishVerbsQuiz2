...
struct PieChartSetUp {
    ...
    init(entrieBon: Double, entrieMal: Double, entrieAide: Double, pieChartView: PieChartView){
        ...
        let lengendEntry1 = LegendEntry(label: "Correcto".localized, form: .default, formSize: .nan, formLineWidth: .leastNonzeroMagnitude, formLineDashPhase: .leastNormalMagnitude, formLineDashLengths: nil, formColor: cBon)
        let lengendEntry2 = LegendEntry(label: "Incorrecto".localized, form: .default, formSize: .nan, formLineWidth: .leastNormalMagnitude, formLineDashPhase: .leastNormalMagnitude, formLineDashLengths: nil, formColor: cMal)
        let lengendEntry3 = LegendEntry(label: "Con ayuda".localized, form: .default, formSize: .nan, formLineWidth: .leastNormalMagnitude, formLineDashPhase: .leastNormalMagnitude, formLineDashLengths: nil, formColor: cAide)
