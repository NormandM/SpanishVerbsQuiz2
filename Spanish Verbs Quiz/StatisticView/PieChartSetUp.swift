...
struct PieChartSetUp {
    ...
    init(entrieBon: Double, entrieMal: Double, entrieAide: Double, pieChartView: PieChartView){
        ...
        let lengendEntry1 = LegendEntry(label: "Correcto".localized)
        lengendEntry1.labelColor = cBon
        let lengendEntry2 = LegendEntry(label: "Incorrecto".localized)
        lengendEntry2.labelColor = cMal
        let lengendEntry3 = LegendEntry(label: "Con ayuda".localized)
